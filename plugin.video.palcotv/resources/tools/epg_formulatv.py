...
def epg_ftv(title):
    ...
    if channel == "la 1" or channel == "la 1 hd":
        ...
        epg_channel = epg_formulatv(params, channel)
        return epg_channel        
    elif channel == "cosmopolitan" or channel == "cosmopolitan tv" or channel == "cosmopolitan hd":
...
def epg_formulatv(params, channel):
    plugintools.log('[%s %s] Cargando EPG de FórmulaTV... %s' % (addonName, addonVersion, repr(params)))
